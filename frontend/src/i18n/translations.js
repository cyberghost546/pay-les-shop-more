  ...
  nl: {
    ...
    profile: {
      ...
      receipts: {
        ...
        kinds: {
          receipt: 'Kassabon',
          invoice: 'Factuur van de winkel',
          customs: 'Douaneformulier',
          other: 'Iets anders',
        },
        note: 'Korte omschrijving',
        notePlaceholder: 'Bijvoorbeeld: kassabon televisie MediaMarkt',
        fileLabel: 'Uw bestand',
        optional: 'optioneel',
        chooseFile: 'Kies een bestand',
        orDrop: 'of sleep het hierheen',
        hint: 'PDF, JPG of PNG, tot 10 MB.',
        uploading: 'Bezig met versturen…',
        uploaded: 'Verstuurd. Ons kantoor kan uw bestand nu inzien.',
        chooseOther: 'Kies een ander bestand',
        notSentYet: 'Nog niet verstuurd',
        send: 'Versturen naar kantoor',
        sending: 'Bezig met versturen…',
        discard: 'Annuleren',
        sent: 'Verstuurd naar ons kantoor',
        failed: 'Het bestand kon niet worden toegevoegd. Probeer het opnieuw.',
        deleteFailed: 'Het bestand kon niet worden verwijderd. Probeer het opnieuw.',
        download: 'Downloaden',
        remove: 'Verwijderen',
      },
      invoices: {
        intro:
          'Van elke betaalde zending maken wij een factuur. Zodra die verstuurd is, staat hij hier klaar als pdf.',
        loading: 'Uw facturen worden geladen…',
        empty: 'U heeft nog geen facturen. Zij verschijnen hier zodra een zending betaald en verwerkt is.',
        failed: 'Uw facturen konden niet worden geladen.',
        retry: 'Opnieuw proberen',
        tracking: 'Zending',
    ...
    profile: {
      ...
      receipts: {
        ...
        kinds: {
          ...
          invoice: 'Invoice from the shop',
          customs: 'Customs form',
          other: 'Something else',
        },
        note: 'Short description',
        notePlaceholder: 'For example: till receipt, television, MediaMarkt',
        fileLabel: 'Your file',
        optional: 'optional',
        ...
        uploading: 'Sending…',
        uploaded: 'Sent. Our office can see your file now.',
        chooseOther: 'Choose a different file',
        notSentYet: 'Not sent yet',
        send: 'Send to the office',
        sending: 'Sending…',
        discard: 'Cancel',
        sent: 'Sent to our office',
        failed: 'That file could not be added. Please try again.',
        deleteFailed: 'That file could not be removed. Please try again.',
        download: 'Download',
        remove: 'Remove',
      },
      invoices: {
        intro:
          'We raise an invoice for every paid shipment. Once it has been sent, it is here as a PDF.',
        loading: 'Loading your invoices…',
        empty: 'You have no invoices yet. They appear here once a shipment has been paid for and processed.',
        failed: 'Your invoices could not be loaded.',
        retry: 'Try again',
        tracking: 'Shipment',
        download: 'Download PDF',
      },
  ...
  pap: {
    ...
    profile: {
      ...
      receipts: {
        ...
        kinds: {
          receipt: 'Bon di kaha',
          invoice: 'Faktura di e tienda',
          customs: 'Formulario di aduana',
          other: 'Otro kos',
        },
        note: 'Deskripshon kòrtiku',
        notePlaceholder: 'Por ehèmpel: bon di televishon MediaMarkt',
        fileLabel: 'Bo dokumento',
        optional: 'opshonal',
        chooseFile: 'Skohe un dokumento',
        orDrop: 'of lastré akinan',
        hint: 'PDF, JPG of PNG, te 10 MB.',
        uploading: 'Ta manda…',
        uploaded: 'Mandá. Nos ofisina por mira bo dokumento awor.',
        chooseOther: 'Skohe un otro dokumento',
        notSentYet: 'Ainda no mandá',
        send: 'Manda pa ofisina',
        sending: 'Ta manda…',
        discard: 'Kanselá',
        sent: 'Mandá pa nos ofisina',
        failed: 'No por a pone e dokumento. Purba atrobe.',
        deleteFailed: 'No por a kita e dokumento. Purba atrobe.',
        download: 'Baha',
        remove: 'Kita',
      },
      invoices: {
        intro:
          'Nos ta traha un faktura pa kada enbio pagá. Ora e ta mandá, e ta pará akinan komo pdf.',
        loading: 'Ta karga bo fakturanan…',
        empty: 'Ainda bo no tin faktura. Nan ta aparesé akinan ora un enbio ta pagá i prosesá.',
        failed: 'No por a karga bo fakturanan.',
        retry: 'Purba atrobe',
        tracking: 'Enbio',
        download: 'Baha pdf',
      },
